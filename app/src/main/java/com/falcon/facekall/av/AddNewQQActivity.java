...
public class AddNewQQActivity extends Activity implements OnClickListener,
	...
	private void save() {
		ArrayList<String> qqList = AVUtil.getQQList(this);
		ArrayList<String> identifierList = AVUtil.getIdentifierList(this);
		ArrayList<String> usersigList = AVUtil.getUserSigList(this);
		EditText editTextQQ = (EditText) findViewById(R.id.edit_text_qq);
		EditText editTextIdentifier = (EditText) findViewById(R.id.edit_text_identifier);
		EditText editTextUserSig = (EditText) findViewById(R.id.edit_text_usersig);
		...
		AVUtil.setQQList(this, qqList);
		AVUtil.setIdentifierList(this, identifierList);
		AVUtil.setUserSigList(this, usersigList);
	}
